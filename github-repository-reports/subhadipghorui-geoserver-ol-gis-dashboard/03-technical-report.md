---
repo: subhadipghorui/geoserver-ol-gis-dashboard
url: https://github.com/subhadipghorui/geoserver-ol-gis-dashboard
...
# subhadipghorui/geoserver-ol-gis-dashboard — Valutazione Tecnica

> **Repository**:
> [subhadipghorui/geoserver-ol-gis-dashboard](https://github.com/subhadipghorui/geoserver-ol-gis-dashboard)
...
| Attività   | 🔴 Inattivo | ultimo commit: 2023-04-13                               |
...
| Campo       | Valore                                                                                                                   |
| ----------- | ------------------------------------------------------------------------------------------------------------------------ |
| Repository  | [subhadipghorui/geoserver-ol-gis-dashboard](https://github.com/subhadipghorui/geoserver-ol-gis-dashboard)                |
| Licenza     | —                                                                                                                        |
| Linguaggio  | —                                                                                                                        |
| Stars       | 3                                                                                                                        |
| Forks       | 0                                                                                                                        |
| Watchers    | 1                                                                                                                        |
| Open Issues | 0                                                                                                                        |
| Creato      | 2023-04-13 (2 anni fa)                                                                                                   |
| Archivio    | No                                                                                                                       |
| Fork        | No                                                                                                                       |
| Topics      | geoserver, gis, openlayers6, wfs, wms                                                                                    |
| Homepage    | https://myiotlab.in                                                                                                      |
| DeepWiki    | [deepwiki.com/subhadipghorui/geoserver-ol-gis-dashboard](https://deepwiki.com/subhadipghorui/geoserver-ol-gis-dashboard) |
