...
# dequelabs/axe-core — Valutazione Tecnica

> **Repository**: [dequelabs/axe-core](https://github.com/dequelabs/axe-core) | **Data analisi**:
...
| Campo       | Valore                                                                           |
| ----------- | -------------------------------------------------------------------------------- |
| Repository  | [dequelabs/axe-core](https://github.com/dequelabs/axe-core)                      |
| Categoria   | Frontend                                                                         |
| Licenza     | MPL-2.0                                                                          |
...
| Watchers    | 174                                                                              |
| Open Issues | 430                                                                              |
| Creato      | 2015-06-10 (10 anni fa)                                                          |
| Archivio    | No                                                                               |
| Fork        | No                                                                               |
| Topics      | a11y, accessibility, axe                                                         |
| Homepage    | https://www.deque.com/axe/                                                       |
| npm         | [https://www.npmjs.com/package/axe-core](https://www.npmjs.com/package/axe-core) |
| DeepWiki    | [deepwiki.com/dequelabs/axe-core](https://deepwiki.com/dequelabs/axe-core)       |
...
| Ultima release     | v4.11.1 (2026-01-06) |
...
| --- | ----------------- | ------------- | ----- | ---- |
| 1   | @WilcoFiers       | 951           | 29.2% | User |
| 2   | @straker          | 881           | 27.0% | User |
| 3   | @dylanb           | 436           | 13.4% | User |
| 4   | @jeeyyy           | 147           | 4.5%  | User |
| 5   | @dmfay            | 128           | 3.9%  | User |
| 6   | @stephenmathieson | 90            | 2.8%  | User |
| 7   | @mfranzke         | 45            | 1.4%  | User |
| 8   | @gaiety-deque     | 45            | 1.4%  | User |
| 9   | @michael-siek     | 43            | 1.3%  | User |
| 10  | @marcysutton      | 41            | 1.3%  | User |
| 11  | @clottman         | 33            | 1.0%  | User |
| 12  | @dbjorge          | 32            | 1.0%  | User |
...
| ------------------- | ---------- |
| Totale release      | 10         |
| Ultima release      | v4.11.1    |
| Data ultima release | 2026-01-06 |
