...
# c2g-dev/city2graph — Valutazione Tecnica

> **Repository**: [c2g-dev/city2graph](https://github.com/c2g-dev/city2graph) | **Data analisi**:
...
| Campo       | Valore                                                                                                                                                                                                                                                                                                     |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Repository  | [c2g-dev/city2graph](https://github.com/c2g-dev/city2graph)                                                                                                                                                                                                                                                |
| Categoria   | Backend                                                                                                                                                                                                                                                                                                    |
...
| Watchers    | 4                                                                                                                                                                                                                                                                                                          |
| Open Issues | 5                                                                                                                                                                                                                                                                                                          |
| Creato      | 2025-01-17 (1 anno fa)                                                                                                                                                                                                                                                                                     |
| Archivio    | No                                                                                                                                                                                                                                                                                                         |
| Fork        | No                                                                                                                                                                                                                                                                                                         |
| Topics      | geoai, geographic-data-science, geographical-information-system, geospatial, geospatial-analysis, gis, gnn, graph-neural-networks, graph-representation-learning, mobility, network-analysis, overturemaps, pyg, python, pytorch, pytorch-geometric, spatial-analysis, transportation, urban-morphometrics |
| Homepage    | https://city2graph.net                                                                                                                                                                                                                                                                                     |
| PyPI        | [https://pypi.org/project/city2graph](https://pypi.org/project/city2graph)                                                                                                                                                                                                                                 |
| DeepWiki    | [deepwiki.com/c2g-dev/city2graph](https://deepwiki.com/c2g-dev/city2graph)                                                                                                                                                                                                                                 |
...
| Ultima release     | v0.3.1 (2026-03-21) |

---

## 4. Contribuenti

Totale contributors: **2** (1 umani, 1 bot)

**Bus Factor**: 🔴 1 — contributor con >10% dei commit totali

| #   | Contributor | Contribuzioni | %     | Tipo |
| --- | ----------- | ------------- | ----- | ---- |
| 1   | @yu-ta-sato | 536           | 98.0% | User |
