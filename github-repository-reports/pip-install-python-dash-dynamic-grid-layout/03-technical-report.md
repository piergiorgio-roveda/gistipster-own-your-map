---
repo: pip-install-python/dash-dynamic-grid-layout
url: https://github.com/pip-install-python/dash-dynamic-grid-layout
...
# pip-install-python/dash-dynamic-grid-layout — Valutazione Tecnica

> **Repository**:
> [pip-install-python/dash-dynamic-grid-layout](https://github.com/pip-install-python/dash-dynamic-grid-layout)
...
| Attività   | 🟡 Rallentato | ultimo commit: 2025-04-02                               |
...
| Campo       | Valore                                                                                                                       |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Repository  | [pip-install-python/dash-dynamic-grid-layout](https://github.com/pip-install-python/dash-dynamic-grid-layout)                |
...
| Watchers    | 1                                                                                                                            |
| Open Issues | 0                                                                                                                            |
| Creato      | 2024-07-27 (1 anno fa)                                                                                                       |
| Archivio    | No                                                                                                                           |
| Fork        | No                                                                                                                           |
| Homepage    | https://pip-install-python.com/pip/dash_dynamic_grid_layout                                                                  |
| PyPI        | [https://pypi.org/project/dash-dynamic-grid-layout](https://pypi.org/project/dash-dynamic-grid-layout)                       |
| DeepWiki    | [deepwiki.com/pip-install-python/dash-dynamic-grid-layout](https://deepwiki.com/pip-install-python/dash-dynamic-grid-layout) |
...
| Metrica            | Valore            |
| ------------------ | ----------------- |
| Ultimo commit      | 2025-04-02        |
| Commit (30 giorni) | 0                 |
| Commit (90 giorni) | 0                 |
| Ultima release     | dash (2024-08-02) |
...
| --- | ------------------- | ------------- | ----- | ---- |
| 1   | @BSd3v              | 30            | 50.8% | User |
| 2   | @pip-install-python | 23            | 39.0% | User |
| 3   | @FistOfMight        | 6             | 10.2% | User |
...
| Totale release      | 1          |
| Ultima release      | dash       |
| Data ultima release | 2024-08-02 |
