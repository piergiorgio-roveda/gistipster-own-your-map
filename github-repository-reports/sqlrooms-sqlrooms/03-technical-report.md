---
repo: sqlrooms/sqlrooms
url: https://github.com/sqlrooms/sqlrooms
...
# sqlrooms/sqlrooms — Valutazione Tecnica

> **Repository**: [sqlrooms/sqlrooms](https://github.com/sqlrooms/sqlrooms) | **Data analisi**:
...
| Campo       | Valore                                                                           |
| ----------- | -------------------------------------------------------------------------------- |
| Repository  | [sqlrooms/sqlrooms](https://github.com/sqlrooms/sqlrooms)                        |
| Categoria   | Frontend                                                                         |
| Licenza     | MIT                                                                              |
...
| Watchers    | 10                                                                               |
| Open Issues | 49                                                                               |
| Creato      | 2024-01-31 (2 anni fa)                                                           |
| Archivio    | No                                                                               |
| Fork        | No                                                                               |
| Homepage    | https://sqlrooms.org                                                             |
| npm         | [https://www.npmjs.com/package/sqlrooms](https://www.npmjs.com/package/sqlrooms) |
| DeepWiki    | [deepwiki.com/sqlrooms/sqlrooms](https://deepwiki.com/sqlrooms/sqlrooms)         |
...
| Ultima release     | v0.29.0-rc.1 (2026-03-01) |

---

## 4. Contribuenti

Totale contributors: **18** (14 umani, 4 bot)

**Bus Factor**: 🔴 1 — contributor con >10% dei commit totali

| #   | Contributor            | Contribuzioni | %     | Tipo |
| --- | ---------------------- | ------------- | ----- | ---- |
| 1   | @ilyabo                | 732           | 76.9% | User |
| 2   | @bdjulbic              | 34            | 3.6%  | User |
| 3   | @lixun910              | 28            | 2.9%  | User |
| 4   | @dmitriy-kostianetskiy | 12            | 1.3%  | User |
| 5   | @albatross97           | 4             | 0.4%  | User |
| 6   | @fhk                   | 2             | 0.2%  | User |
| 7   | @xpectro93             | 2             | 0.2%  | User |
| 8   | @heshan0131            | 2             | 0.2%  | User |
| 9   | @kolmakova             | 1             | 0.1%  | User |
| 10  | @kargeor               | 1             | 0.1%  | User |
| 11  | @igorDykhta            | 1             | 0.1%  | User |
| 12  | @mihajlo-stojkovic     | 1             | 0.1%  | User |

_... e altri 2 contributors_
