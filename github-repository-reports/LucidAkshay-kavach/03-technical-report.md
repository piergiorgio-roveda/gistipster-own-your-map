...
# LucidAkshay/kavach — Valutazione Tecnica

> **Repository**: [LucidAkshay/kavach](https://github.com/LucidAkshay/kavach) | **Data analisi**:
...
| Attività   | 🟢 Attivo | ultimo commit: 2026-03-19                               |
...
| Campo       | Valore                                                                                                                                                      |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Repository  | [LucidAkshay/kavach](https://github.com/LucidAkshay/kavach)                                                                                                 |
| Categoria   | Frontend                                                                                                                                                    |
| Licenza     | GPL-3.0                                                                                                                                                     |
...
| Watchers    | 1                                                                                                                                                           |
| Open Issues | 0                                                                                                                                                           |
| Creato      | 2026-03-14 (< 1 mese fa)                                                                                                                                    |
| Archivio    | No                                                                                                                                                          |
| Fork        | No                                                                                                                                                          |
| Topics      | agents, ai, ai-agent, ai-agents, cybersecurity, cybersecurity-tools, firewall, firewall-management, llm, llm-agent, llms, rust, rust-lang, tauri, tauri-app |
| npm         | [https://www.npmjs.com/package/kavach](https://www.npmjs.com/package/kavach)                                                                                |
| DeepWiki    | [deepwiki.com/LucidAkshay/kavach](https://deepwiki.com/LucidAkshay/kavach)                                                                                  |
...
| Metrica            | Valore              |
| ------------------ | ------------------- |
| Ultimo commit      | 2026-03-19          |
| Commit (30 giorni) | 10                  |
| Commit (90 giorni) | 10                  |
| Trend commit       | ↑ In crescita       |
| Ultima release     | v1.1.0 (2026-03-18) |
