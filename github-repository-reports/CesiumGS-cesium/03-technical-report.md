...
# CesiumGS/cesium — Valutazione Tecnica

> **Repository**: [CesiumGS/cesium](https://github.com/CesiumGS/cesium) | **Data analisi**:
...
| Campo       | Valore                                                                       |
| ----------- | ---------------------------------------------------------------------------- |
| Repository  | [CesiumGS/cesium](https://github.com/CesiumGS/cesium)                        |
...
| Watchers    | 469                                                                          |
| Open Issues | 1581                                                                         |
| Creato      | 2012-03-02 (14 anni fa)                                                      |
| Archivio    | No                                                                           |
| Fork        | No                                                                           |
| Topics      | 3d, 3d-globe, 3d-tiles, cesium, czml, geospatial, gis, gltf, webgl           |
| Homepage    | https://cesium.com/cesiumjs/                                                 |
| npm         | [https://www.npmjs.com/package/cesium](https://www.npmjs.com/package/cesium) |
| DeepWiki    | [deepwiki.com/CesiumGS/cesium](https://deepwiki.com/CesiumGS/cesium)         |
...
| Ultima release     | 1.139.1 (2026-03-06) |
...
| --- | ------------- | ------------- | ----- | ---- |
| 1   | @bagnell      | 5220          | 15.6% | User |
| 2   | @pjcozzi      | 4663          | 14.0% | User |
| 3   | @mramato      | 4472          | 13.4% | User |
| 4   | @lilleyse     | 3375          | 10.1% | User |
| 5   | @ggetz        | 2426          | 7.3%  | User |
| 6   | @kring        | 2045          | 6.1%  | User |
| 7   | @ptrgags      | 1593          | 4.8%  | User |
| 8   | @emackey      | 1510          | 4.5%  | User |
| 9   | @shunter      | 1276          | 3.8%  | User |
| 10  | @sanjeetsuhag | 750           | 2.2%  | User |
| 11  | @jjspace      | 739           | 2.2%  | User |
| 12  | @ebogo1       | 438           | 1.3%  | User |
