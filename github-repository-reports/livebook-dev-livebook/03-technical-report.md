...
# livebook-dev/livebook — Valutazione Tecnica

> **Repository**: [livebook-dev/livebook](https://github.com/livebook-dev/livebook) | **Data
...
| DeepWiki    | [deepwiki.com/livebook-dev/livebook](https://deepwiki.com/livebook-dev/livebook)                                            |
...
| Ultima release     | nightly (2024-10-25) |
...
| --- | ---------------- | ------------- | ----- | ---- |
| 1   | @jonatanklosko   | 1929          | 61.4% | User |
| 2   | @josevalim       | 587           | 18.7% | User |
| 3   | @aleDsz          | 190           | 6.0%  | User |
| 4   | @wojtekmach      | 164           | 5.2%  | User |
| 5   | @hugobarauna     | 104           | 3.3%  | User |
| 6   | @ByeongUkChoi    | 22            | 0.7%  | User |
| 7   | @paulo-valim     | 20            | 0.6%  | User |
| 8   | @Benjamin-Philip | 12            | 0.4%  | User |
| 9   | @moogle19        | 11            | 0.3%  | User |
| 10  | @jeantux         | 11            | 0.3%  | User |
| 11  | @jannikbecher    | 9             | 0.3%  | User |
| 12  | @mruoss          | 9             | 0.3%  | User |
...
| ------------------- | ---------- |
| Totale release      | 10         |
| Ultima release      | nightly    |
| Data ultima release | 2024-10-25 |
