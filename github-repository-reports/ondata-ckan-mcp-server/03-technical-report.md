...
# ondata/ckan-mcp-server — Valutazione Tecnica

> **Repository**: [ondata/ckan-mcp-server](https://github.com/ondata/ckan-mcp-server) | **Data
...
| Campo       | Valore                                                                                                                                                                                                               |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Repository  | [ondata/ckan-mcp-server](https://github.com/ondata/ckan-mcp-server)                                                                                                                                                  |
| Categoria   | Frontend                                                                                                                                                                                                             |
| Licenza     | MIT                                                                                                                                                                                                                  |
...
| npm         | [https://www.npmjs.com/package/ckan-mcp-server](https://www.npmjs.com/package/ckan-mcp-server)                                                                                                                       |
| DeepWiki    | [deepwiki.com/ondata/ckan-mcp-server](https://deepwiki.com/ondata/ckan-mcp-server)                                                                                                                                   |
...
| Ultima release     | v0.4.96 (2026-03-26) |

---

## 4. Contribuenti

Totale contributors: **4** (3 umani, 1 bot)

**Bus Factor**: 🟡 2 — contributor con >10% dei commit totali

| #   | Contributor | Contribuzioni | %     | Tipo |
| --- | ----------- | ------------- | ----- | ---- |
| 1   | @aborruso   | 436           | 83.0% | User |
| 2   | @piersoft   | 20            | 3.8%  | User |
| 3   | @abcgco     | 2             | 0.4%  | User |
