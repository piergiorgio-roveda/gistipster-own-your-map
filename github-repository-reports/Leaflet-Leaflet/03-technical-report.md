...
# Leaflet/Leaflet — Valutazione Tecnica

> **Repository**: [Leaflet/Leaflet](https://github.com/Leaflet/Leaflet) | **Data analisi**:
...
| Watchers    | 885                                                                            |
| Open Issues | 560                                                                            |
| Creato      | 2010-09-22 (15 anni fa)                                                        |
| Archivio    | No                                                                             |
| Fork        | No                                                                             |
| Topics      | javascript, leaflet, maps                                                      |
| Homepage    | https://leafletjs.com                                                          |
| npm         | [https://www.npmjs.com/package/Leaflet](https://www.npmjs.com/package/Leaflet) |
| DeepWiki    | [deepwiki.com/Leaflet/Leaflet](https://deepwiki.com/Leaflet/Leaflet)           |
...
| --- | -------------- | ------------- | ----- | ---- |
| 1   | @mourner       | 3698          | 58.9% | User |
| 2   | @IvanSanchez   | 439           | 7.0%  | User |
| 3   | @danzel        | 301           | 4.8%  | User |
| 4   | @yohanboniface | 210           | 3.3%  | User |
| 5   | @jonkoops      | 148           | 2.4%  | User |
| 6   | @Falke-Design  | 129           | 2.1%  | User |
| 7   | @jfirebaugh    | 116           | 1.8%  | User |
| 8   | @cherniavskii  | 109           | 1.7%  | User |
| 9   | @perliedman    | 97            | 1.5%  | User |
| 10  | @ghybs         | 75            | 1.2%  | User |
| 11  | @simon04       | 72            | 1.1%  | User |
| 12  | @jacobtoye     | 53            | 0.8%  | User |
...
| Totale release      | 10         |
| Ultima release      | dev        |
| Data ultima release | 2025-09-17 |
