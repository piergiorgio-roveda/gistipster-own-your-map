...
# pola-rs/polars — Valutazione Tecnica

> **Repository**: [pola-rs/polars](https://github.com/pola-rs/polars) | **Data analisi**: 2026-03-27
> | **Versione**: 1
...
| Ultima release     | py-1.39.3 (2026-03-20) |
...
| --- | ----------------- | ------------- | ----- | ---- |
| 1   | @ritchie46        | 6008          | 49.5% | User |
| 2   | @alexander-beedie | 1009          | 8.3%  | User |
| 3   | @nameexhaustion   | 755           | 6.2%  | User |
| 4   | @orlp             | 707           | 5.8%  | User |
| 5   | @coastalwhite     | 699           | 5.8%  | User |
| 6   | @stinodego        | 609           | 5.0%  | User |
| 7   | @MarcoGorelli     | 475           | 3.9%  | User |
| 8   | @reswqa           | 231           | 1.9%  | User |
| 9   | @mcrumiller       | 183           | 1.5%  | User |
| 10  | @zundertj         | 182           | 1.5%  | User |
| 11  | @ghuls            | 142           | 1.2%  | User |
| 12  | @kdn36            | 133           | 1.1%  | User |
...
| ------------------- | ---------- |
| Totale release      | 10         |
| Ultima release      | py-1.39.3  |
| Data ultima release | 2026-03-20 |
