---
repo: GeoRetina/Arion
url: https://github.com/GeoRetina/Arion
...
# GeoRetina/Arion — Valutazione Tecnica

> **Repository**: [GeoRetina/Arion](https://github.com/GeoRetina/Arion) | **Data analisi**:
...
| Campo       | Valore                                                                                   |
| ----------- | ---------------------------------------------------------------------------------------- |
| Repository  | [GeoRetina/Arion](https://github.com/GeoRetina/Arion)                                    |
| Categoria   | Frontend                                                                                 |
| Licenza     | GPL-3.0                                                                                  |
...
| Watchers    | 1                                                                                        |
| Open Issues | 2                                                                                        |
| Creato      | 2025-07-23 (8 mesi fa)                                                                   |
| Archivio    | No                                                                                       |
| Fork        | No                                                                                       |
| Topics      | ai, ai-agents, geoai, geospatial, geospatial-analysis, gis, llm, mapping, remote-sensing |
| Homepage    | https://www.georetina.com                                                                |
| DeepWiki    | [deepwiki.com/GeoRetina/Arion](https://deepwiki.com/GeoRetina/Arion)                     |
