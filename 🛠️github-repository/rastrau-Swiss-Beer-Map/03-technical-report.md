---
repo: rastrau/Swiss-Beer-Map
url: https://github.com/rastrau/Swiss-Beer-Map
...
# rastrau/Swiss-Beer-Map — Valutazione Tecnica

> **Repository**: [rastrau/Swiss-Beer-Map](https://github.com/rastrau/Swiss-Beer-Map) | **Data
...
| Attività   | 🔴 Inattivo | ultimo commit: 2022-06-12                               |
...
| Campo       | Valore                                                                             |
| ----------- | ---------------------------------------------------------------------------------- |
| Repository  | [rastrau/Swiss-Beer-Map](https://github.com/rastrau/Swiss-Beer-Map)                |
| Categoria   | Frontend                                                                           |
| Licenza     | —                                                                                  |
...
| Watchers    | 3                                                                                  |
| Open Issues | 0                                                                                  |
| Creato      | 2014-04-28 (11 anni fa)                                                            |
| Archivio    | Sì                                                                                 |
| Fork        | No                                                                                 |
| DeepWiki    | [deepwiki.com/rastrau/Swiss-Beer-Map](https://deepwiki.com/rastrau/Swiss-Beer-Map) |
...
| --- | ----------- | ------------- | ----- | ---- |
| 1   | @rastrau    | 10            | 83.3% | User |
| 2   | @tsager     | 2             | 16.7% | User |
