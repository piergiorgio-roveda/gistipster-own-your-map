...
url: https://github.com/Guepard-Corp/gfs
...
# Guepard-Corp/gfs — Valutazione Tecnica

> **Repository**: [Guepard-Corp/gfs](https://github.com/Guepard-Corp/gfs) | **Data analisi**:
...
| Campo       | Valore                                                                            |
| ----------- | --------------------------------------------------------------------------------- |
| Repository  | [Guepard-Corp/gfs](https://github.com/Guepard-Corp/gfs)                           |
| Categoria   | Backend                                                                           |
| Licenza     | MIT                                                                               |
| Linguaggio  | Rust                                                                              |
| Stars       | 104                                                                               |
...
| Watchers    | 3                                                                                 |
| Open Issues | 11                                                                                |
| Creato      | 2026-02-24 (1 mese fa)                                                            |
| Archivio    | No                                                                                |
| Fork        | No                                                                                |
| Topics      | agentic-ai, agents, clickhouse, database, mcp, mysql, postgresql, version-control |
| Homepage    | https://gfs.guepard.run                                                           |
| DeepWiki    | [deepwiki.com/Guepard-Corp/gfs](https://deepwiki.com/Guepard-Corp/gfs)            |
...
| Ultima release     | v0.2.0 (2026-03-23) |

---

## 4. Contribuenti

Totale contributors: **6** (4 umani, 2 bot)

**Bus Factor**: 🟡 2 — contributor con >10% dei commit totali

| #   | Contributor | Contribuzioni | %     | Tipo |
| --- | ----------- | ------------- | ----- | ---- |
| 1   | @hchalouati | 57            | 68.7% | User |
| 2   | @aymennasri | 5             | 6.0%  | User |
| 3   | @YGhorbel   | 3             | 3.6%  | User |
| 4   | @WWKoch     | 1             | 1.2%  | User |
