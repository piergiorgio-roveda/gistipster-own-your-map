...
# datahub-project/datahub — Valutazione Tecnica

> **Repository**: [datahub-project/datahub](https://github.com/datahub-project/datahub) | **Data
...
| Campo       | Valore                                                                               |
| ----------- | ------------------------------------------------------------------------------------ |
| Repository  | [datahub-project/datahub](https://github.com/datahub-project/datahub)                |
| Categoria   | Backend                                                                              |
| Licenza     | Apache-2.0                                                                           |
| Linguaggio  | Java                                                                                 |
| Stars       | 11.724                                                                               |
...
| Watchers    | 249                                                                                  |
| Open Issues | 814                                                                                  |
| Creato      | 2015-11-18 (10 anni fa)                                                              |
| Archivio    | No                                                                                   |
| Fork        | No                                                                                   |
| Topics      | data-catalog, data-discovery, data-governance, datahub, hacktoberfest, metadata      |
| Homepage    | https://datahub.com                                                                  |
| DeepWiki    | [deepwiki.com/datahub-project/datahub](https://deepwiki.com/datahub-project/datahub) |
...
| Ultima release     | v1.5.0.1 (2026-03-25) |
...
| --- | ----------------- | ------------- | ----- | ---- |
| 1   | @hsheth2          | 1468          | 14.9% | User |
| 2   | @theseyi          | 1298          | 13.2% | User |
| 3   | @david-leifker    | 779           | 7.9%  | User |
| 4   | @anshbansal       | 710           | 7.2%  | User |
| 5   | @jjoyce0510       | 565           | 5.7%  | User |
| 6   | @mars-lan         | 514           | 5.2%  | User |
| 7   | @chriscollins3456 | 424           | 4.3%  | User |
| 8   | @treff7es         | 401           | 4.1%  | User |
| 9   | @gabe-lyons       | 397           | 4.0%  | User |
| 10  | @mayurinehate     | 316           | 3.2%  | User |
| 11  | @alyiwang         | 313           | 3.2%  | User |
| 12  | @shirshanka       | 295           | 3.0%  | User |
