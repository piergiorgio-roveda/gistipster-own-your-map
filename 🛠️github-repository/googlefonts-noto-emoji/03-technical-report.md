...
# googlefonts/noto-emoji — Valutazione Tecnica

> **Repository**: [googlefonts/noto-emoji](https://github.com/googlefonts/noto-emoji) | **Data
...
| Campo       | Valore                                                                             |
| ----------- | ---------------------------------------------------------------------------------- |
| Repository  | [googlefonts/noto-emoji](https://github.com/googlefonts/noto-emoji)                |
| Categoria   | Backend                                                                            |
| Licenza     | OFL-1.1                                                                            |
| Linguaggio  | Python                                                                             |
| Stars       | 4633                                                                               |
...
| Watchers    | 118                                                                                |
| Open Issues | 103                                                                                |
| Creato      | 2015-06-05 (10 anni fa)                                                            |
| Archivio    | No                                                                                 |
| Fork        | No                                                                                 |
| PyPI        | [https://pypi.org/project/noto-emoji](https://pypi.org/project/noto-emoji)         |
| DeepWiki    | [deepwiki.com/googlefonts/noto-emoji](https://deepwiki.com/googlefonts/noto-emoji) |
...
| Commit (30 giorni) | 0                   |
| Commit (90 giorni) | 0                   |
| Ultima release     | v2.051 (2025-09-15) |

---

## 4. Contribuenti

Totale contributors: **28** (28 umani, 0 bot)

**Bus Factor**: 🟡 2 — contributor con >10% dei commit totali

| #   | Contributor   | Contribuzioni | %     | Tipo |
| --- | ------------- | ------------- | ----- | ---- |
| 1   | @dougfelt     | 298           | 45.4% | User |
| 2   | @rsheeter     | 185           | 28.2% | User |
| 3   | @anthrotype   | 57            | 8.7%  | User |
| 4   | @guidotheelen | 37            | 5.6%  | User |
| 5   | @roozbehp     | 14            | 2.1%  | User |
| 6   | @behdad       | 10            | 1.5%  | User |
| 7   | @qqd-google   | 10            | 1.5%  | User |
| 8   | @RoelN        | 9             | 1.4%  | User |
| 9   | @sg3510       | 7             | 1.1%  | User |
| 10  | @davelab6     | 4             | 0.6%  | User |
| 11  | @khaledhosny  | 4             | 0.6%  | User |
| 12  | @corollari    | 2             | 0.3%  | User |
...
| ------------------- | ---------- |
| Totale release      | 10         |
| Ultima release      | v2.051     |
| Data ultima release | 2025-09-15 |
