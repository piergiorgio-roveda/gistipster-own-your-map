...
# microsoft/RoadDetections — Valutazione Tecnica

> **Repository**: [microsoft/RoadDetections](https://github.com/microsoft/RoadDetections) | **Data
...
| Attività   | 🟢 Attivo | ultimo commit: 2025-10-27                               |
...
| Campo       | Valore                                                                                 |
| ----------- | -------------------------------------------------------------------------------------- |
| Repository  | [microsoft/RoadDetections](https://github.com/microsoft/RoadDetections)                |
| Categoria   | Backend                                                                                |
| Licenza     | NOASSERTION                                                                            |
| Linguaggio  | C#                                                                                     |
| Stars       | 608                                                                                    |
...
| Watchers    | 21                                                                                     |
| Open Issues | 8                                                                                      |
| Creato      | 2021-04-23 (4 anni fa)                                                                 |
| Archivio    | No                                                                                     |
| Fork        | No                                                                                     |
| DeepWiki    | [deepwiki.com/microsoft/RoadDetections](https://deepwiki.com/microsoft/RoadDetections) |
...
| --- | ------------------------------- | ------------- | ----- | ---- |
| 1   | @MissingRoadsDiscoveryMicrosoft | 27            | 50.9% | User |
| 2   | @USMissingRoadsDiscovery        | 20            | 37.7% | User |
