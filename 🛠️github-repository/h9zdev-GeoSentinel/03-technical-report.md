...
# h9zdev/GeoSentinel — Valutazione Tecnica

> **Repository**: [h9zdev/GeoSentinel](https://github.com/h9zdev/GeoSentinel) | **Data analisi**:
...
| Attività   | 🟢 Attivo | ultimo commit: 2026-03-09                               |
...
| Campo       | Valore                                                                     |
| ----------- | -------------------------------------------------------------------------- |
| Repository  | [h9zdev/GeoSentinel](https://github.com/h9zdev/GeoSentinel)                |
| Categoria   | Frontend                                                                   |
| Licenza     | NOASSERTION                                                                |
| Linguaggio  | HTML                                                                       |
| Stars       | 701                                                                        |
...
| Watchers    | 11                                                                         |
| Open Issues | 0                                                                          |
| Creato      | 2026-01-16 (2 mesi fa)                                                     |
| Archivio    | No                                                                         |
| Fork        | No                                                                         |
| DeepWiki    | [deepwiki.com/h9zdev/GeoSentinel](https://deepwiki.com/h9zdev/GeoSentinel) |
...
| Metrica            | Valore                   |
| ------------------ | ------------------------ |
| Ultimo commit      | 2026-03-09               |
| Commit (30 giorni) | 10                       |
| Commit (90 giorni) | 10                       |
| Trend commit       | ↑ In crescita            |
| Ultima release     | GeoSentinel (2026-02-27) |

---

## 4. Contribuenti

Totale contributors: **5** (4 umani, 1 bot)

**Bus Factor**: 🟡 2 — contributor con >10% dei commit totali

| #   | Contributor  | Contribuzioni | %     | Tipo |
| --- | ------------ | ------------- | ----- | ---- |
| 1   | @h9zdev      | 63            | 80.8% | User |
| 2   | @Steiynbrodt | 8             | 10.3% | User |
| 3   | @VaradScript | 3             | 3.8%  | User |
| 4   | @H9yzz       | 2             | 2.6%  | User |
...
| ------------------- | ----------- |
| Totale release      | 1           |
| Ultima release      | GeoSentinel |
| Data ultima release | 2026-02-27  |
