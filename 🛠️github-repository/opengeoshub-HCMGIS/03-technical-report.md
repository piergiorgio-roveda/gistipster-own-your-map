---
repo: opengeoshub/HCMGIS
url: https://github.com/opengeoshub/HCMGIS
...
# opengeoshub/HCMGIS — Valutazione Tecnica

> **Repository**: [opengeoshub/HCMGIS](https://github.com/opengeoshub/HCMGIS) | **Data analisi**:
...
| Campo       | Valore                                                                     |
| ----------- | -------------------------------------------------------------------------- |
| Repository  | [opengeoshub/HCMGIS](https://github.com/opengeoshub/HCMGIS)                |
| Categoria   | Plugin                                                                     |
| Licenza     | GPL-3.0                                                                    |
| Linguaggio  | Python                                                                     |
| Stars       | 43                                                                         |
...
| Watchers    | 4                                                                          |
| Open Issues | 0                                                                          |
| Creato      | 2018-04-03 (7 anni fa)                                                     |
| Archivio    | No                                                                         |
| Fork        | No                                                                         |
| Topics      | basemaps, opendata, qgis-plugin, spatial-analysis, vn-2000                 |
| DeepWiki    | [deepwiki.com/opengeoshub/HCMGIS](https://deepwiki.com/opengeoshub/HCMGIS) |
...
| --- | ----------- | ------------- | ----- | ---- |
| 1   | @thangqd    | 170           | 85.0% | User |
| 2   | @hcmgis     | 25            | 12.5% | User |
| 3   | @nvkelso    | 5             | 2.5%  | User |
