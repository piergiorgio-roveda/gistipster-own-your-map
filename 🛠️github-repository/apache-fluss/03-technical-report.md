...
# apache/fluss — Valutazione Tecnica

> **Repository**: [apache/fluss](https://github.com/apache/fluss) | **Data analisi**: 2026-03-27 |
> **Versione**: 1
...
| DeepWiki    | [deepwiki.com/apache/fluss](https://deepwiki.com/apache/fluss)            |
...
| Ultima release     | v0.9.0-incubating (2026-03-02) |
...
| --- | ---------------- | ------------- | ----- | ---- |
| 1   | @wuchong         | 192           | 17.4% | User |
| 2   | @luoyuxia        | 142           | 12.9% | User |
| 3   | @swuferhong      | 131           | 11.9% | User |
| 4   | @loserwang1024   | 79            | 7.2%  | User |
| 5   | @MehulBatra      | 54            | 4.9%  | User |
| 6   | @LiebingYu       | 53            | 4.8%  | User |
| 7   | @polyzos         | 45            | 4.1%  | User |
| 8   | @platinumhamburg | 43            | 3.9%  | User |
| 9   | @caozhen1937     | 34            | 3.1%  | User |
| 10  | @beryllw         | 33            | 3.0%  | User |
| 11  | @michaelkoepf    | 31            | 2.8%  | User |
| 12  | @zcoo            | 30            | 2.7%  | User |
...
| ------------------- | ----------------- |
| Totale release      | 9                 |
| Ultima release      | v0.9.0-incubating |
| Data ultima release | 2026-03-02        |
