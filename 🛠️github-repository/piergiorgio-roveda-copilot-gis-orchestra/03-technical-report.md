---
repo: piergiorgio-roveda/copilot-gis-orchestra
url: https://github.com/piergiorgio-roveda/copilot-gis-orchestra
...
# piergiorgio-roveda/copilot-gis-orchestra — Valutazione Tecnica

> **Repository**:
> [piergiorgio-roveda/copilot-gis-orchestra](https://github.com/piergiorgio-roveda/copilot-gis-orchestra)
...
| Attività   | 🟢 Attivo | ultimo commit: 2025-12-07                               |
...
| Campo       | Valore                                                                                                                 |
| ----------- | ---------------------------------------------------------------------------------------------------------------------- |
| Repository  | [piergiorgio-roveda/copilot-gis-orchestra](https://github.com/piergiorgio-roveda/copilot-gis-orchestra)                |
| Categoria   | Frontend                                                                                                               |
| Licenza     | —                                                                                                                      |
...
| Watchers    | 0                                                                                                                      |
| Open Issues | 0                                                                                                                      |
| Creato      | 2025-11-07 (5 mesi fa)                                                                                                 |
| Archivio    | No                                                                                                                     |
| Fork        | No                                                                                                                     |
| DeepWiki    | [deepwiki.com/piergiorgio-roveda/copilot-gis-orchestra](https://deepwiki.com/piergiorgio-roveda/copilot-gis-orchestra) |
...
| --- | ------------------- | ------------- | ------ | ---- |
| 1   | @piergiorgio-roveda | 18            | 100.0% | User |
